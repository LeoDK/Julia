...
int main (int argc, char **argv)
{
    if (argc != 12)
    {
        printf("Usage : ./evol x1 y1 x2 y2 |c| arg(c) width height limit range_arg steps\n");
        return 0;
    }
    ...
    Complex *c = __new__Complex_Polar (strtof(argv[5],NULL), strtof(argv[6],NULL));
    ...
    float range_arg = strtof(argv[10], NULL);
    int steps = strtol(argv[11], NULL, 10);
